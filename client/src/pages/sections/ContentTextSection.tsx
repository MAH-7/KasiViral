      ...
      <div className="container-custom">
        <div className="text-center mb-12 lg:mb-16 animate-fade-up">
          <h2 className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-6">
            See <span className="text-gradient">KasiViral</span> in Action
          </h2>
          <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Watch how easy it is to create viral threads in seconds with our
            AI-powered platform
          </p>
        </div>
              ...
              {!isVideoPlaying ? (
                ...
                <div className="w-full max-w-3xl aspect-video">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/rOJmc2yv0E8?autoplay=1"
                    title="Demo Video"
                    frameBorder="0"
